...
export default defineConfig({
  lang: 'zh-CN',
  title: 'Anemo',
  description: '轻量，更快，更强大的跨平台 QQ 机器人框架',
  head: [
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          {
            items: [
              { text: 'GitHub 团队', link: 'https://github.com/AnemoLab' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Anemo 标准事件', link: '/api/kivi_events' },
    ...
    outline: 2,
    outlineTitle: '大纲',
    socialLinks: [{ icon: 'github', link: 'https://github.com/AnemoLab/Anemo' }],
    ...
    editLink: {
      pattern: 'https://github.com/AnemoLab/docs/edit/main/src/:path',
      text: '在 GitHub 上编辑'
    }
  }
})
